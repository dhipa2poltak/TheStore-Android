package com.dpfht.testproductlist.feature_list.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.dpfht.testproductlist.data.model.remote.Product
import com.dpfht.testproductlist.ext.toRupiahString
import com.dpfht.testproductlist.feature_list.databinding.RowProductBinding
import com.squareup.picasso.Picasso

class ProductListAdapter(private val products: ArrayList<Product>): RecyclerView.Adapter<ProductListAdapter.ProductListViewHolder>() {
